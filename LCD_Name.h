...
#define lcd_output_enable(x)lcd.enable = x; //PORTEbits.RE1 = x //for simulator
 // use this for actual hardware
#define lcd_output_rs(x) lcd.rs = x; //PORTEbits.RE2 = x //for simulator
 //for simulator
